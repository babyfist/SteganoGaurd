          ...
          {!isMounted ? (
            ...
            <>
              ...
              <div className="flex items-center gap-2 mt-4 flex-wrap">
                ...
                <Input id="import-identity-file" type="file" accept=".json,application/json" className="hidden" ref={importIdentityRef} onChange={e => handleImportIdentity(e.target.files?.[0] || null)} />
        ...
        <DialogContent>
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="add-contact-file" type="file" accept=".json,application/json" className="hidden" ref={addContactRef} onChange={e => setPendingContactKeyFile(e.target.files?.[0] || null)} />
